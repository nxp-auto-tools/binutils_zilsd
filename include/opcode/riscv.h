...
/* addibne */
#define EXTRACT_XL_ADDIBNE_IMM(x) \
  ((RV_X(x, 20, 9)) << 1)
#define EXTRACT_XL_ADDIBNE_SCALE(x) \
  (RV_X(x, 29, 2))
...
#define ENCODE_XLCZ_LGPH_IMM(x) \
  (RV_X(x, 1, 15) << 15)
#define ENCODE_XLCZ_LGPW_IMM(x) \
  (RV_X(x, 2, 15) << 15)
#define ENCODE_XLCZ_LGPD_IMM(x) \
  (RV_X(x, 3, 15) << 15)
#define ENCODE_XLCZ_SGPB_IMM(x) \
...
#define ENCODE_XL_ADDIBNE_IMM(x) \
  ((RV_X(x, 1, 9) << 20))
#define ENCODE_XL_ADDIBNE_SCALE(x) \
  (RV_X(x, 0, 2) << 29)
...
/* addibne extension.  */
#define VALID_XL_ADDIBNE_IMM(x) (EXTRACT_XL_ADDIBNE_IMM(ENCODE_XL_ADDIBNE_IMM(x)) == (x))
...
#define OP_MASK_XL_SCALE		0x3
#define OP_SH_XL_SCALE		29

#define OP_MASK_XL_RS1		0x1f
#define OP_SH_XL_RS1		15
...
enum riscv_insn_class
{
  ...
  INSN_CLASS_ZPRV,
  INSN_CLASS_XXLDSP,
  INSN_CLASS_XXLDSPN1X,
  INSN_CLASS_XXLDSPN2X,
  INSN_CLASS_XXLDSPN3X,
  INSN_CLASS_V,
  INSN_CLASS_ZVEF,
  INSN_CLASS_ZVBB,
  INSN_CLASS_ZVBC,
  ...
  INSN_CLASS_XXLCZ,
  INSN_CLASS_XXLCZ_PSTINC,
  INSN_CLASS_XXLCZ_BMRK,
  INSN_CLASS_XXLCZ_BITOP,
  INSN_CLASS_XXLCZ_ABS,
  INSN_CLASS_XXLCZ_MAC,
  INSN_CLASS_XXLCZ_SLET,
