...
#define CSR_UIP 0x44
/* Xxlcz instructions*/
#define MATCH_XL_LB        0x5b
#define MASK_XL_LB         0x707f
#define MATCH_XL_LBU       0x405b
#define MASK_XL_LBU        0x707f
#define MATCH_XL_LH        0x105b
#define MASK_XL_LH         0x707f
#define MATCH_XL_LHU       0x505b
#define MASK_XL_LHU        0x707f
#define MATCH_XL_LW        0x205b
#define MASK_XL_LW         0x707f
#define MATCH_XL_SB        0x4023
#define MASK_XL_SB         0x707f
#define MATCH_XL_SH        0x5023
#define MASK_XL_SH         0x707f
#define MATCH_XL_SW        0x6023
#define MASK_XL_SW         0x707f
#define MATCH_XL_ABS       0xe000033
#define MASK_XL_ABS        0xfff0707f
#define MATCH_XL_MULI      0x40001033
#define MASK_XL_MULI       0xc000707f
#define MATCH_XL_SLET      0x4002033
#define MASK_XL_SLET       0xfe00707f
#define MATCH_XL_SLETU     0x4003033
#define MASK_XL_SLETU      0xfe00707f
#define MATCH_XL_EXTRACT   0xc0000033
#define MASK_XL_EXTRACT    0xc000707f
#define MATCH_XL_EXTRACTR  0x80000033
#define MASK_XL_EXTRACTR   0xfe00707f
#define MATCH_XL_EXTRACTU  0xc0001033
#define MASK_XL_EXTRACTU   0xc000707f
#define MATCH_XL_EXTRACTUR 0x80001033
#define MASK_XL_EXTRACTUR  0xfe00707f
#define MATCH_XL_INSERT    0xc0002033
#define MASK_XL_INSERT     0xc000707f
#define MATCH_XL_INSERTR   0x80002033
#define MASK_XL_INSERTR    0xfe00707f
#define MATCH_XL_BSET      0xc0004033
#define MASK_XL_BSET       0xc000707f
#define MATCH_XL_BSETR     0x80004033
#define MASK_XL_BSETR      0xfe00707f
#define MATCH_XL_BCLR      0xc0003033
#define MASK_XL_BCLR       0xc000707f
#define MATCH_XL_BCLRR     0x80003033
#define MASK_XL_BCLRR      0xfe00707f
#define MATCH_XL_CLB       0x04000033
#define MASK_XL_CLB        0xfff0707f
#define MATCH_XL_FL1       0x06000033
#define MASK_XL_FL1        0xfff0707f
#define MATCH_XL_FF1       0x08000033
#define MASK_XL_FF1        0xfff0707f
#define MATCH_XL_FL0       0x0a000033
#define MASK_XL_FL0        0xfff0707f
#define MATCH_XL_FF0       0x0c000033
#define MASK_XL_FF0        0xfff0707f
#define MATCH_XL_BEQI      0x2063
#define MASK_XL_BEQI       0x707f
#define MATCH_XL_BNEI      0x3063
#define MASK_XL_BNEI       0x707f
#define MATCH_XL_DECBNEZ   0xfa00007b
#define MASK_XL_DECBNEZ    0xfff0707f
#define MATCH_C_DECBNEZ    0xb102
#define MASK_C_DECBNEZ     0xf103
#define MATCH_XL_BITREV    0x10000033
#define MASK_XL_BITREV     0xf800707f
#define MATCH_XL_ADDRCHK   0x107b
#define MASK_XL_ADDRCHK    0x707f
#define MATCH_XL_BEZM      0x207b
#define MASK_XL_BEZM       0x707f
#define MATCH_XL_NZMSK     0xfe00007b
#define MASK_XL_NZMSK      0xfff0707f
#define MATCH_XL_FFNZ      0xfc00007b
#define MASK_XL_FFNZ       0xfff0707f
#define MATCH_XL_LGP_B     0x2b
#define MASK_XL_LGP_B      0Xc000307f
#define MATCH_XL_LGP_BU    0X4000002b
#define MASK_XL_LGP_BU     0Xc000307f
#define MATCH_XL_LGP_H     0x102b
#define MASK_XL_LGP_H      0xc000707f
#define MATCH_XL_LGP_HU    0x502b
#define MASK_XL_LGP_HU     0xc000707f
#define MATCH_XL_LGP_W     0x202b
#define MASK_XL_LGP_W      0xc000707f
#define MATCH_XL_SGP_B     0xc000002b
#define MASK_XL_SGP_B      0xc000307f
#define MATCH_XL_SGP_H     0x8000102b
#define MASK_XL_SGP_H      0xc000707f
#define MATCH_XL_SGP_W     0x8000202b
#define MASK_XL_SGP_W      0xc000707f
/* Xxlcz instructions(RV64 only) */
#define MATCH_XL_LWU       0x605b
#define MASK_XL_LWU        0x707f
#define MATCH_XL_LD        0x305b
#define MASK_XL_LD         0x707f
#define MATCH_XL_SD        0x7023
#define MASK_XL_SD         0x707f
#define MATCH_XL_LGP_WU    0x602b
#define MASK_XL_LGP_WU     0xc000707f
#define MATCH_XL_LGP_D     0x302b
#define MASK_XL_LGP_D      0xc000707f
#define MATCH_XL_SGP_D     0x8000302b
...
#define NUCLEI_MTIBCFG_INFO   0xfc3
...
//TEE
#define NUCLEI_SPMPCFG0       0x1a0
#define NUCLEI_SPMPCFG1       0x1a1
#define NUCLEI_SPMPCFG2       0x1a2
#define NUCLEI_SPMPCFG3       0x1a3
#define NUCLEI_SPMPADDR0      0x1b0
#define NUCLEI_SPMPADDR1      0x1b1
#define NUCLEI_SPMPADDR2      0x1b2
...
//VPU
#define NUCLEI_CCM_MFP16MODE        0x7e2
//PPI
#define NUCLEI_CCM_MPPICFG_INFO     0x7f0
//FIO
#define NUCLEI_CCM_MFIOCFG_INFO     0x7f1
//SMP
#define NUCLEI_CCM_MIRGB_INFO       0x7f7
//NCDEV
#define NUCLEI_MDEVB    0x7f3
#define NUCLEI_MDEVM    0x7f4
#define NUCLEI_MNOCB    0x7f5
#define NUCLEI_MNOCM    0x7f6
//custom csr
...
DECLARE_CSR(mtlbcfg_info, NUCLEI_MTIBCFG_INFO, CSR_CLASS_DEBUG, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
...
DECLARE_CSR(spmpcfg0, NUCLEI_SPMPCFG0, CSR_CLASS_DEBUG, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(spmpcfg1, NUCLEI_SPMPCFG1, CSR_CLASS_DEBUG, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(spmpcfg2, NUCLEI_SPMPCFG2, CSR_CLASS_DEBUG, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(spmpcfg3, NUCLEI_SPMPCFG3, CSR_CLASS_DEBUG, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(spmpaddr0, NUCLEI_SPMPADDR0, CSR_CLASS_DEBUG, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(spmpaddr1, NUCLEI_SPMPADDR1, CSR_CLASS_DEBUG, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(spmpaddr2, NUCLEI_SPMPADDR2, CSR_CLASS_DEBUG, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
...
DECLARE_CSR(mfp16mode, NUCLEI_CCM_MFP16MODE, CSR_CLASS_DEBUG, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mppicfg_info, NUCLEI_CCM_MPPICFG_INFO, CSR_CLASS_DEBUG, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mfiocfg_info, NUCLEI_CCM_MFIOCFG_INFO, CSR_CLASS_DEBUG, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mirgb_info, NUCLEI_CCM_MIRGB_INFO, CSR_CLASS_DEBUG, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mdevb, NUCLEI_MDEVB, CSR_CLASS_DEBUG, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mdevm, NUCLEI_MDEVM, CSR_CLASS_DEBUG, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mnocb, NUCLEI_MNOCB, CSR_CLASS_DEBUG, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mnocm, NUCLEI_MNOCM, CSR_CLASS_DEBUG, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
//custom csr
