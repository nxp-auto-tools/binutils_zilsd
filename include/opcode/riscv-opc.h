...
#define NUCLEI_SAFETYCTRL     0x813
#define NUCLEI_STLRESULT      0x814
...
DECLARE_CSR(safetyctrl, NUCLEI_SAFETYCTRL, CSR_CLASS_DEBUG, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(stlresult, NUCLEI_STLRESULT, CSR_CLASS_DEBUG, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
