...
static struct riscv_supported_ext riscv_supported_std_ext[] =
{
  ...
  {"k",		ISA_SPEC_CLASS_DRAFT,		1, 0, 0 },
  {"p",		ISA_SPEC_CLASS_DRAFT,		1, 0, 0 },
  {NULL, 0, 0, 0, 0}
};
...
static struct riscv_supported_ext riscv_supported_std_z_ext[] =
{
  ...
  {"zpn",   ISA_SPEC_CLASS_DRAFT,  0, 94,  0},
  {"zprv",  ISA_SPEC_CLASS_DRAFT,  0, 94,  0},
  {"zpsf",  ISA_SPEC_CLASS_DRAFT,  0, 94,  0},
			     ...
			     enum riscv_insn_class insn_class)
{
  switch (insn_class)
    ...
    case INSN_CLASS_ZBA:
      return (riscv_subset_supports (rps, "zba") || riscv_subset_supports (rps, "b"));
    case INSN_CLASS_ZBB:
      return (riscv_subset_supports (rps, "zbb") || riscv_subset_supports (rps, "b"));
    case INSN_CLASS_ZBC:
      return (riscv_subset_supports (rps, "zbc") || riscv_subset_supports (rps, "b"));
    case INSN_CLASS_ZBS:
      return (riscv_subset_supports (rps, "zbs") || riscv_subset_supports (rps, "b"));
   
    case INSN_CLASS_ZBKB:
      return (riscv_subset_supports (rps, "zbkb") || riscv_subset_supports (rps, "zkn") || riscv_subset_supports (rps, "zks") || riscv_subset_supports (rps, "zk"));
    case INSN_CLASS_ZBKC:
      return (riscv_subset_supports (rps, "zbkc") || riscv_subset_supports (rps, "zkn") || riscv_subset_supports (rps, "zks") || riscv_subset_supports (rps, "zk"));
    case INSN_CLASS_ZBKX:
      return (riscv_subset_supports (rps, "zbkx") || riscv_subset_supports (rps, "zkn") || riscv_subset_supports (rps, "zks") || riscv_subset_supports (rps, "zk"));
    case INSN_CLASS_ZBB_OR_ZBKB:
      return (riscv_subset_supports (rps, "zbb") || riscv_subset_supports (rps, "zbkb") || riscv_subset_supports (rps, "zkn") || riscv_subset_supports (rps, "zks") || riscv_subset_supports (rps, "zk"));
    case INSN_CLASS_ZBC_OR_ZBKC:
      return (riscv_subset_supports (rps, "zbc") || riscv_subset_supports (rps, "zbkc") || riscv_subset_supports (rps, "zkn") || riscv_subset_supports (rps, "zks") || riscv_subset_supports (rps, "zk"));
    case INSN_CLASS_ZKND:
      return (riscv_subset_supports (rps, "zknd") || riscv_subset_supports (rps, "zkn") || riscv_subset_supports (rps, "zk"));
    case INSN_CLASS_ZKNE:
      return (riscv_subset_supports (rps, "zkne") || riscv_subset_supports (rps, "zkn") || riscv_subset_supports (rps, "zk"));
    case INSN_CLASS_ZKNH:
      return (riscv_subset_supports (rps, "zknh") || riscv_subset_supports (rps, "zkn") || riscv_subset_supports (rps, "zk"));
    case INSN_CLASS_ZKND_OR_ZKNE:
      return (riscv_subset_supports (rps, "zknd") || riscv_subset_supports (rps, "zkne") || riscv_subset_supports (rps, "zkn") || riscv_subset_supports (rps, "zk"));
    case INSN_CLASS_ZKSED:
      return (riscv_subset_supports (rps, "zksed") || riscv_subset_supports (rps, "zks"));
    case INSN_CLASS_ZKSH:
      return (riscv_subset_supports (rps, "zksh") || riscv_subset_supports (rps, "zks"));
				 ...
				 enum riscv_insn_class insn_class)
{
  switch (insn_class)
    ...
    case INSN_CLASS_ZBS:
      return "zbs' or `b";
    case INSN_CLASS_ZBKB:
      return "zbkb' or `b' or `k";
    case INSN_CLASS_ZBKC:
      return "zbkc' or `b' or `k";
    case INSN_CLASS_ZBKX:
      return "zbkx' or `k";
    case INSN_CLASS_ZBB_OR_ZBKB:
      return _("zbb' or `zbkb' or `b' or `k");
    case INSN_CLASS_ZBC_OR_ZBKC:
      return _("zbc' or `zbkc' or `b' or `k");
    case INSN_CLASS_ZKND:
      return "zknd' or `k";
    case INSN_CLASS_ZKNE:
      return "zkne' or `k";
